...
"""
Original source:
https://github.com/online-judge-tools/verification-helper/blob/master/onlinejudge_verify/languages/cplusplus_bundle.py

online-judge-tools/verification-helper is licensed under the MIT License.
